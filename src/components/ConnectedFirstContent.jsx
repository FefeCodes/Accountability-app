            ...
            <div className="w-full flex flex-row justify-between items-start">
                <div className="flex flex-col gap-y-5">
                    ...
                    <div className="flex flex-row gap-x-5">
                        <div>
                            <button className="bg-[#3C91E6] rounded-4xl px-6 py-3 text-white">Connected</button>
                        </div>
                        <div>
                            <button className="border border-[#3C91E6] px-6 py-3 text-[#3C91E6] rounded-4xl">Message</button>
                        </div>
                    </div>
                </div>
